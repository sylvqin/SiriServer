...
class alarmPlugin(Plugin):
    ...
    localizations = {
        'Alarm': {
            "settingAlarm": {
                "en-US": u"Setting the Alarm\u2026","fr-FR": u"Activation de l'alarme\u2026"
            }, "alarmWasSet": {
                "en-US": "Your alarm is set for {0}:{1} {2}.","fr-FR": u"Votre alarme est r\u00E9gl\u00E9e pour {0}:{1} {2}."
            }, "alarmSetWithLabel": {
                "en-US": "Your alarm {0} {1} is set for {2}:{3} {4}.","fr-FR": u"Votre alarme {0} {1} est r\u00E9gl\u00E9e pour {2}:{3} {4}."
        }
    }
    }
    ...
    res = {
        'setAlarm': {
            ...
            'fr-FR': u'.*(programme|r\u00E8gle|r\u00E9gler?).* alarme .* (0?[1-9]|1[012])([0-5]\d)?\s?([APap][mM])\s?(\bcalled|named|labeled\b)?\s?(([a-z0-9]{1,7}\s)?([a-z0-9]{1,7})\s?([a-z0-9]{1,7}))?'
    }
    }
